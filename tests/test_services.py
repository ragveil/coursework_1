...
def test_get_transactions_correct(json_sample: list[dict]) -> None:
...
def test_get_transactions_decode_error(wrong_json_list: list[dict]) -> None:
...
def test_search_item_correct(transactions: list[dict], simple_search_expected: str) -> None:
...
def test_search_item_incorrect(transactions: list[dict], keyword: str, expected: str) -> None:
    assert search_item(transactions, keyword) == expected


def test_search_item_empty() -> None:
    assert search_item([], "супермаркет") == "Совпадений не найдено"


def test_search_telephone_numbers(transactions: list[dict], telephone_numbers_expected: str) -> None:
...
def test_search_personal_transactions(transactions: list[dict], personal_search_expected: str) -> None:
